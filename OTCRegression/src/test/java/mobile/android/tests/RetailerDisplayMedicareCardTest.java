...
public class RetailerDisplayMedicareCardTest extends AbstractTest {

    @Test
    public void retailerDisplayMedicareCardTest () {
        String[] expectedRetailers = {"CVS", "Discount Drug Mart", "Dollar General",
                "Duane Reade", "Family Dollar", "Freds, H-E-B", "Independent Merchants",
                "Meijer", "Rite Aid", "Sams Club", "WALGREENS", "Walmart", "Winn-Dixie Stores"};
